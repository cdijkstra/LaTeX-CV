...
\workentry
  ...
  {
    Migrated the OTAP environments of the main website of the applied university to secure Azure subscriptions, 
...
{ \tech{C\#}, \tech{MVC}, \tech{Azure}, \tech{MSSQL}, \tech{Bicep}, \tech{JQuery}, \tech{TailwindCSS}, \tech{Archimate}, \tech{Hub Spoke Architecture}, \tech{CI/CD}, \tech{Scrum}, \tech{REST APIs}, \tech{XML}}

\workentry
{.NET Software Developer / DevOps Engineer}
{Feb 2022 -- Mar 2023}
{PayByLink (Ede) via \textbf{Xebia | Xpirit} (Hilversum)}
...
{\tech{.NET Standard} \tech{.NET Framework} \tech{Resource Files} (.resx) \tech{CSS3} \tech{Javascript} \tech{Azure Function Apps} \tech{MSSQL} \tech{database migrations}.
}

\workentry
{.NET Software Developer / Azure Cloud Engineer}
{Sep 2020 -- Mar 2023}
{Taqa (Alkmaar) via \textbf{Xebia | Xpirit}}
...
}
{
    ...
    \tech{Docker} 
    \tech{Kubernetes} 
    \tech{High Availability with failovers} 
    \tech{Specflow} 
    \tech{MSTest} 
    \tech{git} 
    \tech{TDD}. 
